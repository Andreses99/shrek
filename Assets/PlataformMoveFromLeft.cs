...
public class PlataformMoveFromLeft : MonoBehaviour
{
    public float speed = 5f; // Velocidad de movimiento

    private Vector3 initialPosition; // Posición inicial del objeto
    private bool movingRight = false; // Indica si el objeto se está moviendo hacia la derecha o hacia la izquierda
    ...
    void Update()
    {
        ...
        if (movingRight)
        {
            // Si todavía no llegó al punto final (X=520)
        ...
        {
            // Si todavía no llegó al punto inicial (X=420)
